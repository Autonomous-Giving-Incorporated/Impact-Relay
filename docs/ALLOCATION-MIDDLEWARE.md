...
**Status:** MVP host is Fund-Intel · Impact Relay owns proof/trail discipline long-term  
...
- **Today:** MVP proof endpoints and packet UI ship with the Fund-Intel middleware package (Specs SPEC-002A / SPEC-020 Profile B).  
- **Next for this repo:** optional binding of middleware allocation IDs to IR ledger / UOF receipts when a client needs full donor-chain evidence; keep HD-IR agent contracts and `docs/platform-conformance.yml` as product-internal gates; platform pin remains Specs v1.x.

## Cross-links

| Resource | URL |
| --- | --- |
| Fund-Intel middleware status | https://github.com/scrimshawlife-ctrl/Fund-Intel/blob/main/docs/ALLOCATION-MIDDLEWARE.md |
| Hacker Dojo pilot | https://github.com/scrimshawlife-ctrl/Fund-Intel/blob/main/docs/HACKER-DOJO-ALLOCATION-PILOT.md |
